...
export class MessageControllerBase {
  ...
  async createMessage(
    ...
    return await this.service.createMessage({
      ...
      select: {
        ...
        campaignContactFirstName: true,
        campaignContactLastName: true,
        type: true,
        templateId: true,
        templateName: true,
        content: true,
  ...
  async findMessageEmails(
    @common.Req() request: Request,
    @common.Param() params: MessageWhereUniqueInput
  ): Promise<Email[]> {
    const query = plainToClass(EmailFindManyArgs, request.query);
    const results = await this.service.findMessageEmails(params.id, {
      ...query,
      select: {
        id: true,
  ...
  @common.Post("/:id/messageEmails")
  @nestAccessControl.UseRoles({
    resource: "Message",
    action: "update",
    possession: "any",
  })
  async connectMessageEmails(
    @common.Param() params: MessageWhereUniqueInput,
  ...
  @common.Patch("/:id/messageEmails")
  @nestAccessControl.UseRoles({
    resource: "Message",
    action: "update",
    possession: "any",
  })
  async updateMessageEmails(
    @common.Param() params: MessageWhereUniqueInput,
    @common.Body() body: EmailWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/messageEmails")
  @nestAccessControl.UseRoles({
    resource: "Message",
    action: "update",
    possession: "any",
  })
  async disconnectMessageEmails(
    @common.Param() params: MessageWhereUniqueInput,
    @common.Body() body: EmailWhereUniqueInput[]
  ): Promise<void> {
    const data = {
